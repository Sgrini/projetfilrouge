...
$stmt = $db->prepare("SELECT utilisateur_id, utilisateur_nom, utilisateur_mot_de_passe, Id_role FROM utilisateurs WHERE utilisateur_mail=:utilisateur_mail");
$stmt->execute([":utilisateur_mail" => ['utilisateur_mail']]);
$utilisateur = $stmt->fetch();

if ($utilisateur & password_verify($_POST["utilisateur_mot_de_passe"], $row["utilisateur_mot_de_passe"])) {
  session_start();
